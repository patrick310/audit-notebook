...
public class Target : MonoBehaviour
{
    ...
    // The color the target flashes to when hit by an arrow
    ...
    private void Start()
    {
        ...
        defaultColor = mRend.material.color; // Store a reference to the default color of the target
    }
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        // Briefly change the color of the target to confirm it has been hit
        mRend.material.color = hitColor;
        Invoke("SetDefaultColor", 0.5f); // Invokes helper method to reset color after 0.5 seconds
    ...
    private void Fall()
    {
        ...
        // Iterate over each of target's transfrom children (i.e. arrows that have struck it) and do the same to them
